...
import fun.efto.luna.core.plugin.builtin.method.visitor.ExitMethodVisitor;
 ...
 */
public class ExitMethodInjector extends AbstractMethodInjector {
    @Override
    protected MethodVisitor createMethodVisitor(AsmInjectionContext context, BytecodeAssembler bytecodeAssembler) {
        return new ExitMethodVisitor(Constants.AMS_API_VERSION, context, bytecodeAssembler);
    }
